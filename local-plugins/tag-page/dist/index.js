      ...
      return /* @__PURE__ */ u2("div", { class: "popover-hint", children: [
        ...
        /* @__PURE__ */ u2("div", { children: tags.map((t2) => {
          ...
          const contentPage = allFiles.find(
            (file) => file.slug === `tags/${t2}` || file.slug === `tags/${t2}/index`
          );
...
var TagPage = (opts) => ({
  ...
  generate({ content, cfg }) {
    ...
    for (const tag of tags) {
      const hasChildTags = tag !== "index" && [...tags].some((other) => other !== tag && other.startsWith(`${tag}/`));
      const slug2 = hasChildTags ? joinSegments("tags", tag, "index") : joinSegments("tags", tag);
