# Eleven things wrong with India's cybersecurity system: what the experts say

India has no updated national cybersecurity policy since 2013, no accountable cyber regulatory body, no consequence for security auditors who certify poor cybersecurity systems, and companies doesn't loose anything if they deny a breach. These are a few problems in Indian cybersecurity that we identified while we spoke to several experts. 

Here are the eleven problems they they have highlighted:
...
2. **The blackhole problem of CERT-in where the public have to give all the disclosures only to receive nothing back** 
...
3. **India's cybersecurity disclosure regime makes denying a breach the safest legal option for a company than to make itself accountable**
...
4.  **India has had no updated national cybersecurity policy for more than a decade**
...
He also raised a structural explanation, that a firm's empanelment status may itself depend on not reporting problems on government systems, but explicitly asked that this claim not be attributed to him and that an independent source be found.
...
**What can be done:** Srikanth points to the financial sector, where a dedicated regulator for audit firms now exists with powers up to withdrawing an auditor's licence, and argues cyber auditing needs "the similar thing." Guttula notes the regulatory tightening has already begun on the financial side: NFRA inspections of the Big 4 network firms "have repeatedly flagged deficiencies in independence, documentation and professional skepticism," the RBI now requires IT Strategy Committees led by independent directors with substantial IT expertise, and ICAI is moving to formal Information Systems Audit Standards 
  ...
  8. **A compliance security certificate has become the norm and replaced the security standard that it was supposed to represent.**
...
Detection events from the M-SOC and entity SOCs would be tagged at source using a common taxonomy mapped to CSCRF, NCIIPC and CERT-In controls 
  ...
  9. **Outside regulated banking sector, Indian companies treat cybersecurity as a least preference and additional cost that needs to be minimised.
...
Jonnalagadda emphasises the overall community advantages of good coordination in knowledge sharing, arguing that lack of community benefits is also disincentivising the companies from public disclosures. 
...
> "There are organizations where this is seen as extra cost. And then there are organizations where, by the quality of hires and the quality of tools and processes, these costs are basically auto-absorbed. So it doesn't cost anything extra to ensure that security guarantee." - Srikanth L
  ...
  10.  **Basic security awareness is missing at every layer of the software supply chain, from developers to procurement to end users**
...
The ex-SISA analyst saw the same pattern in the recent [CBSE case](https://www.medianama.com/2026/06/223-cbse-2026-evaluation-crisis-timeline/), where credentials sat in plain sight in the page source. 
...
**What can be done:** Srikanth said that the security consciousness "has to come from education," and built into how developers are trained, so that standard secure practices run automatically the way type-checking now runs in an editor, at no marginal cost.


 11. **Attackers have already put AI into their workflow, while defenders might have to wait for budget cycles and circulars**
...
His own case supplies the arithmetic. The [investigation](https://www.medianama.com/2026/06/223-security-vulnerabilities-rbi-bank-in-registry-sensitive-data/) and [the 30-page report](https://bankin-report.cashlessconsumer.in) that would once have taken him ten days took a couple of hours with AI orchestration; the fix, which he describes as trivial, took the operator 16 days.
