...
## some resources 
1. The Complete Guide to AI Security -- ([pdf](https://services.google.com/fh/files/misc/wiz_complete_guide_to_ai_security_final.pdf))

- [MIT AI Risk Repository](https://airisk.mit.edu/): an open taxonomy of documented AI risks.
- [OECD.AI Incidents Monitor (AIM)](https://oecd.ai/en/incidents): tracked AI incidents worldwide.
